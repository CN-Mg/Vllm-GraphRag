...
/* 管理文件相关的全局状态（React Context）*/
// 定义文件相关的上下文（File Context），提供文件列表、LLM模型选择、图类型、选中的Node和Relationship等状态管理功能
// 持久化状态：从 localStorage 读取历史选中的节点 / 关系标签，适配当前数据库凭证
// 解决 “逐层传参” 问题：所有子组件可通过 useFileContext 直接访问 / 修改文件状态
