...
/* Content 组件是应用的核心内容区域，负责展示文件列表、处理用户交互、管理全局状态等 */
// 调用后端 API 提取文件数据（extractData/extractHandler）
// 管理全局状态：数据库连接状态、文件处理加载状态、弹窗显隐、聊天模式等
// 交互外部服务：跳转 Neo4j Bloom 可视化链接
// 上下文交互：操作 FileContext（文件数据）、UserCredentials（数据库凭证）
